...
const PLANS: PlanInfo[] = [
  {
    ...
    description: 'Pour découvrir Senior+',
    fonctionnalites: [
      'Rituel du matin (1 médicament)',
      '5 activités par jour',
      '1 proche maximum',
    ],
  ...
  },
  {
    ...
    fonctionnalites: [
      ...
      'Rituel complet + médicaments illimités',
      'Décodage de courriers',
      'Compagnon vocal IA',
...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    reponse:
      'Oui. Toutes vos données sont hébergées en Suisse, conformément à la LPD. Elles ne sont jamais revendues ni partagées avec des tiers sans votre consentement explicite.',
  },
  {
    question: 'Puis-je partager mon abonnement avec ma famille ?',
    reponse:
      "Le plan Famille permet d'inviter jusqu'à 3 proches dans votre cercle familial. Chaque proche dispose de son propre profil et accès à l'application.",
  },
  {
    ...
    >
      ...
      <View style={[styles.enteteCartePlan, { backgroundColor: plan.couleurFond }]}>
        <View style={styles.ligneNomPlan}>
          ...
          {estActuel && (
            <Badge texte="Plan actuel" variante={plan.id === 'famille' ? 'primaire' : plan.id === 'serenite' ? 'accent' : 'neutre'} />
          )}
        </View>
      ...
      <View style={styles.corpsCarte}>
        ...
        {estActuel && (
          <View style={[styles.badgePlanActuel, { backgroundColor: plan.couleurPrimaire + '15', borderColor: plan.couleurPrimaire }]}>
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onFermer}>
      <View style={styles.overlayModal}>
        <View style={styles.contenuModal}>
          ...
          <Texte variante="corps" couleur={couleurs.texteSecondaire} align="center" style={styles.texteModal}>
            Pour souscrire à l'abonnement Senior + {plan.nom}, rendez-vous sur notre site web depuis un navigateur ou téléchargez l'application sur l'App Store ou Google Play.
          </Texte>
...
export default function AbonnementProfiteScreen() {
