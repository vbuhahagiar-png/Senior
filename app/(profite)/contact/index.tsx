...
// ─── Réponses pré-programmées de Nia ─────────────────────────────────────────

const REPONSES_NIA: { mots: string[]; reponse: string }[] = [
  {
    mots: ['rituel', 'matin', 'quotidien', 'medicament', 'humeur'],
    reponse:
      "Le rituel du matin est votre rendez-vous quotidien avec vous-même. Chaque matin, vous notez votre humeur, confirmez vos médicaments et cochez une activité physique. Cela prend 2 minutes et aide vos proches à savoir que tout va bien. 🌿",
  },
  {
    mots: ['proche', 'ajouter', 'famille', 'invitation', 'aidant'],
    reponse:
      "Pour ajouter un proche aidant, allez dans l'onglet Famille et appuyez sur le bouton + en haut. Vous recevrez un lien d'invitation à partager. Votre proche créera son compte et vous serez connectés automatiquement.",
  },
  {
    mots: ['abonnement', 'plan', 'tarif', 'prix', 'gratuit', 'changer', 'payer', 'serenite', 'sérénité'],
    reponse:
      "Senior+ propose 3 plans : Gratuit (idéal pour commencer), Famille à CHF 24.90/mois (fonctionnalités complètes + cercle familial), et Sérénité à CHF 39.90/mois (services personnalisés + conseiller dédié). 30 jours d'essai gratuit sans engagement !",
  },
  {
    mots: ['calendrier', 'importer', 'google', 'outlook', 'apple', 'agenda', 'rendez-vous'],
    reponse:
      "Vous pouvez importer vos rendez-vous depuis Google Calendar, Outlook ou Apple Calendar. Dans l'onglet Activités, appuyez sur l'icône calendrier en haut à droite et suivez les instructions.",
  },
  {
    mots: ['decodage', 'décodage', 'courrier', 'lettre', 'administratif', 'impot', 'assurance'],
    reponse:
      "Le décodage de courriers utilise l'intelligence artificielle pour analyser vos lettres administratives (impôts, sécurité sociale, assurances) et vous les expliquer en langage simple. Disponible avec le plan Famille.",
  },
  {
    mots: ['securite', 'sécurité', 'donnees', 'données', 'prive', 'confidentialite', 'suisse', 'securise', 'sécurisé'],
    reponse:
      "Absolument. Vos données sont hébergées en Suisse, conformes à la loi nLPD (équivalent suisse du RGPD). Nous n'utilisons jamais vos informations à des fins publicitaires. Vous pouvez supprimer votre compte et toutes vos données à tout moment.",
  },
]
...
const CHIPS: { label: string; message: string }[] = [
  { label: 'Rituel du matin ?', message: 'Comment fonctionne le rituel du matin ?' },
  { label: 'Ajouter un proche ?', message: 'Comment ajouter un proche ?' },
  { label: 'Mon abonnement ?', message: 'Comment changer mon abonnement ?' },
  { label: 'Importer calendrier ?', message: 'Comment importer mon calendrier ?' },
  { label: 'Décodage de courriers ?', message: "Qu'est-ce que le décodage de courriers ?" },
  { label: "Sécurité de l'app ?", message: "L'app est-elle sécurisée ?" },
]

// ─── Message de bienvenue Nia ─────────────────────────────────────────────────

function creerMessageBienvenue(): Message {
  return {
    id: 'bienvenue',
    role: 'nia',
    texte: "Bonjour ! Je suis Nia, votre assistante Senior+. Comment puis-je vous aider aujourd'hui ?",
